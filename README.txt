...
The output file contains the header of protein sequences which had stretches with values of 
net charge and ratio greater than or equal to the chosen cut-off, and the number of stretches found.
